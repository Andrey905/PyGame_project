...
cannon_surf = pygame.image.load('cannon.png')
wheel_surf = pygame.image.load('new_wheel.png')
...
class Bullet:
    ...
    def draw_bullet(self):
        pygame.draw.rect(self.__game_screen, (67, 67, 67), (self.__x - self.width // 2, self.__y, self.width,
                                                            self.height))
